...
import { type LoadingIcon } from "./types.ts";
...
<template>
  <i class="bin-icon-loading" :class="{[`bin-icon-loading-${type}`]: type}" :style="{ width: size, height: size, color: color }">
  </i>
</template>
...
.bin-icon-loading {
  ...
  &.bin-icon-loading-spin {
    mask-image: url(data:image/svg+xml;base64,);
  }

  &.bin-icon-loading-dots {
